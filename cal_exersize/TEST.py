...
from cal_exersize.exercise.arm_curl import bp as arm_bp

exec = Excersize_service()



# cap = cv2.VideoCapture('/Users/gimseungheon/Desktop/김승헌/sessac_python/cal_excersize/videos/Bicep Curl.mp4')
